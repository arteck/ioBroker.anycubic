...
class WebsocketController {
     ...
     */
    start(subscribeObjects, onMessageCallback) {
        ...
        wsClient.on('close', async () => {
            ...
            this.adapter.setStateChanged('info.online', false, true);
            this.adapter.log.info('Websocket connection closed. Attempting to reconnect...');
        });
    }
    ...
    autoRestart() {
        ...
        this.autoRestartTimeout = setTimeout(() => {
            this.start(this._subscribeObjects, this._onMessageCallback);
        }, WS_RESTART_TIMEOUT);
    }
