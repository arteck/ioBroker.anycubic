...
const COMMANDS = {
    dryer_start: {
        ...
        def: false,
        scripts: {
            true: 'SET_TEMPERATURE_FAN_TARGET temperature_fan=dryer target=55',
            false: 'SET_TEMPERATURE_FAN_TARGET temperature_fan=dryer target=0'
        }
    },
    dryer_temp: {
        ...
        def: 0,
        scripts: {
            '*': 'SET_TEMPERATURE_FAN_TARGET temperature_fan=dryer target={value}'
        }
    }
};
